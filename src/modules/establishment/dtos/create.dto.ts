...
export default class EstablishmentCreateDto {
  constructor(public readonly name: string, public readonly latitude: number, public readonly longitude: number) {}
  ...
  static from(body: Partial<EstablishmentCreateDto>) {
    ...
    return new EstablishmentCreateDto(body.name, body.latitude, body.longitude);
  }
}
